...
module.exports =
{
	...
	createUser: function(credentials)
	{
		...
		request({
		    headers: {
				...
				'VsitPassword':password,
				'VsitDeveloperId':this.developerId,
				'VsitFirstName':credentials.firstName,
				'VsitLastName':credentials.lastName,
				'VsitPhone1':checkUndefined(credentials.phone1),
				'VsitPhone2':checkUndefined(credentials.phone2),
				'VsitPhone3':checkUndefined(credentials.phone3),
		    },
		    uri: 'https://siv.voiceprintportal.com/sivservice/api/users',
		    body: '',
		    method: 'POST'}
	...
	authentication: function(credentials)
	{
		var password = getSHA256(credentials.password);
			...
			'VsitPassword':password,
			'VsitDeveloperId':this.developerId,
	  		'VsitAccuracy': credentials.accuracy,
	  		'VsitAccuracyPasses': credentials.accuracyPasses,
	  		'VsitAccuracyPassIncrement': credentials.accuracyPassIncrement,
	  		'VsitConfidence': credentials.confidence,
				'ContentLanguage':checkUndefined(credentials.contentLanguage),
			},
